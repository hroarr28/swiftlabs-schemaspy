      ...
      <main className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-12">
            Upload a SQL dump, get interactive ER diagrams, and export as PNG, Markdown, or PDF — perfect for documentation, presentations, and onboarding
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="text-left">
              ...
              <p className="text-gray-600">
                Export as PNG for presentations, Markdown for docs, or PDF for sharing
              </p>
            </div>
          </div>
